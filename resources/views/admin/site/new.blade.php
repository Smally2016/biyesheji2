            ...
            <div class="box-body">
                <form role="form-horizontal" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-sm-offset-2 col-sm-8">
                            <label>地址</label>
                            <div id="r-result"><input type="text" id="suggestId" size="20" value="" name="address" class="form-control"/></div>
...
@section('js')
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=iREuauGcXGvMKv1lq9ZLtzvd0afQF2Ob"></script>
