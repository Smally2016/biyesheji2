        ...
        <div class="callbacks_container">
            <ul class="rslides" id="slider">
                <li>
                    ...
                    <div class="caption">
                        <h3>创新开拓</h3>
                        <p>公司领导人有着丰富的执行经验和朝阳之气，有着团队合作与执着精神，富有创新能力与开拓潜力。</p>
                    </div>
                </li>
                <li>
                        ...
                        <div class="ed-gal-effect slow-zoom horizontal">
                            ...
                            <div class="ed-text-box">
                                <div class="ed-gal-text">
                                    <h4>Profession</h4>
                                    <p>Sit accusamus, vel blanditiis iure minima ipsa molestias minus laborum velit,
                                        nulla.</p>
                                </div>
                            </div>
                        </div>
...
<script src="web/js/jquery.filterizr.js"></script>
<script src="web/js/controls.js"></script>
<!-- Kick off Filterizr -->
<script type="text/javascript">
    $(function () {
